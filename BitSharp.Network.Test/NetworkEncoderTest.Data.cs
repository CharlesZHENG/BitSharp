...
namespace BitSharp.Network.Test
{
    public partial class NetworkEncoderTest
    {
        ...
        (
            Version: 0x01,
            BlockLocatorHashes: ImmutableArray.Create(UInt256.ParseHex("00112233445566778899aabbccddeeff00112233445566778899aabbccddeeff"), UInt256.ParseHex("ffeeddccbbaa99887766554433221100ffeeddccbbaa99887766554433221100")),
            HashStop: UInt256.ParseHex("8899aabbccddeeff00112233445566778899aabbccddeeff0011223344556677")
        );
        ...
        (
            Type: 0x01,
            Hash: UInt256.ParseHex("00112233445566778899aabbccddeeff00112233445566778899aabbccddeeff")
        );
