...
namespace BitSharp.Core.Script
{
    public enum ScriptOp
    {
        ...
        OP_2MUL = 0x8D, // The input is multiplied by 2. Currently disabled.
        OP_2DIV = 0x8E, // The input is divided by 2. Currently disabled.
        ...
        OP_MUL = 0x95, // a is multiplied by b. Currently disabled.
        OP_DIV = 0x96, // a is divided by b. Currently disabled.
        OP_MOD = 0x97, // Returns the remainder after dividing a by b. Currently disabled.
        ...
        OP_NOP1 = 0xB0, // The word is ignored.
