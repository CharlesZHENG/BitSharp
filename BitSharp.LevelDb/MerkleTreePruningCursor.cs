...
namespace BitSharp.LevelDb
{
    ...
    //    private readonly LevelDbBlockTxesCursor cursor;

    //    public MerkleTreePruningCursor(int blockIndex, LevelDbBlockTxesCursor cursor)
    //    {
    ...
    //        if (blockIndex != blockIndexColumn.Value.Value)
    ...
    //        if (blockIndex != recordBlockIndexColumn.Value.Value)
    //            throw new InvalidOperationException();
